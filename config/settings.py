...
if os.getenv("DB_ENGINE", "sqlite").lower() in {"postgres", "postgresql"}:
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("POSTGRES_DB", "digitalizacion"),
            "USER": os.getenv("POSTGRES_USER", "digitalizacion"),
...
LANGUAGE_CODE = "es-mx"
TIME_ZONE = os.getenv("DJANGO_TIME_ZONE", "America/Merida")
USE_I18N = True
USE_TZ = True
...
DATA_UPLOAD_MAX_MEMORY_SIZE = MAX_IMPORT_FILE_BYTES + 1024 * 1024
FILE_UPLOAD_MAX_MEMORY_SIZE = min(MAX_IMPORT_FILE_BYTES, 2_621_440)

SCANNER_INBOX_ROOT = os.getenv("SCANNER_INBOX_ROOT", "")
DIGITAL_REPOSITORY_ROOT = os.getenv("DIGITAL_REPOSITORY_ROOT", "")
